...
class AssessedFurniture(Scene):
    def construct(self):
        ...
        for i, angle_extent in enumerate(angles):
            angle_rad = -angle_extent * DEGREES
            
            rotations = angle_extent / 360

            radius_decrease = start_radius * 0.5 * rotations

            end_radius = start_radius - radius_decrease
            ...
            spiral_group.add(spiral_segment).shift(UP* 0.2)
